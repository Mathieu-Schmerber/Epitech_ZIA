...
public:
    ...
    static std::string getResponse(const std::string& content, const std::string& status, int code, std::map<Response::RData, std::string> other_components = {}, std::vector<std::pair<std::string, std::string>> params = {});
